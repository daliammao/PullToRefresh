package com.daliammao.ptr.header;
...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHeaderHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        if (arr != null) {
            mRotateAniTime = arr.getInt(R.styleable.PtrClassicHeader_ptr_update_rotate_ani_time, mRotateAniTime);
        }
        buildAnimation();
    ...
    public void onUIPositionChange(PtrFrameLayout frame, boolean isUnderTouch, byte status, PtrIndicator ptrIndicator) {
        ...
        if (currentPos < mOffsetToRefresh && lastPos >= mOffsetToRefresh) {
            if (isUnderTouch && status == PtrFrameLayout.PTR_STATUS_PREPARE_REFRESH) {
